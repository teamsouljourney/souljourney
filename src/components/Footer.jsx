  ...
  if (
    ...
    return (
      <div className="bg-offWhite dark:bg-customBlack-dark w-full bottom-0 z-20 pt-20">
          ...
          <div className="">
            <NavLink to="/">
              <img
                ...
                className="h-[125px] min-h-[1rem] min-w-[1rem]"
              />
            </NavLink>
          </div>
          <ul className="flex flex-col items-center pr-6">
            <li className="my-2 whitespace-nowrap">
              <NavLink
                className="hover:text-mauve-dark dark:hover:text-pink-light text-xs sm:text-base"
                to="/contact"
        ...
        <div className="flex flex-col sm:flex-row px-6 text-sm items-center sm:justify-between border-t-[1px] border-offWhite-dark w-full">
          <div>
                ...
                >
                  ...
                  >
                    ...
                    <path
                      ...
                      className="fill-offWhite dark:fill-customBlack-dark"
                    />
                  </svg>
                </NavLink>
              </li>
          ...
          <div className="my-2 sm:my-4 text-xs sm:text-sm text-navy dark:text-offWhite">
