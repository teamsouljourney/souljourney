  ...
  return (
    ...
    >
      <div className="relative z-10 text-white text-center p-4 md:p-8 flex flex-col justify-center items-center h-full">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-[90px] font-bold w-full sm:w-[90%] md:w-[80%] mx-auto mb-4 md:mb-6 mt-14"
          style={{
        ...
        <p
          className="text-sm sm:text-base md:text-lg lg:text-xl mb-4 px-2 sm:px-4 md:px-12 w-full max-w-4xl mx-auto mt-6"
          style={{
