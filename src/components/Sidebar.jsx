...
const Sidebar = () => {
  ...
  return (
    <>
      <div className=" w-dvw h-dvh bg-red-200 grid grid-cols-7">
        {/* SideBar */}
        <div className="col-span-1 bg-white">
          <div className="p-2 h-full w-full flex flex-col bg-white dark:bg-navy border-r border-r-gray-200">
            {/* Logo */}
            <a href="#">
