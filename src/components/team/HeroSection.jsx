...
const HeroSection = () => {
  return (
    ...
    <a href="#" target="_blank" rel="noreferrer"
        className="border border-navy rounded-2xl py-1 px-4 text-offWhite  text-sm mb-5 hover:scale-105 transition duration-300 ease-in-out mt-8 font-urbanist">Meet Our Team Of Experts
        </a>
