...
const Buttons = ({ children, to, onClick, type, className }) => {
  ...
  const buttonStyles = {
    ...
    type22:"px-6 py-3 text-lg text-white rounded-lg bg-gradient-to-r from-navy to-seaGreen hover:bg-gradient-to-r hover:from-navy-dark hover:to-seaGreen-dark transition-transform duration-150 ease-in-out active:scale-95", //team-teamDetail.jsx 
